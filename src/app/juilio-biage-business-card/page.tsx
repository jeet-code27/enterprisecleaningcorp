...
export const metadata: Metadata = {
  title: { absolute: "Julio Biage | Director of Operations | Enterprise Cleaning Corp" },
  description: "Official digital business card for Julio Biage, Director of Operations at Enterprise Cleaning Corporation. Contact directly or download vCard / PDF.",
  alternates: {
    canonical: "https://www.enterprisecleaningcorp.com/juilio-biage-business-card"
  },
  robots: {
    index: true,
    follow: true,
      ...
      <div className="container mx-auto max-w-4xl relative z-10 space-y-6 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-white font-bold text-sm sm:text-base group-hover:text-[#0090c8] transition-colors">508-688-1437</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-white font-bold text-xs sm:text-base truncate group-hover:text-[#0090c8] transition-colors">enterprisejuliob@gmail.com</div>
              </div>
            </a>
        ...
        <div className="bg-gradient-to-r from-[#0090c8] to-[#006088] rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center text-white shadow-2xl space-y-4 sm:space-y-6">
          ...
          <p className="text-white/90 text-xs sm:text-sm max-w-xl mx-auto font-medium leading-relaxed">
            Contact Julio Biage directly or request an on-site walkthrough for your facility in Central MA, Rhode Island, or Southern NH.
          </p>
