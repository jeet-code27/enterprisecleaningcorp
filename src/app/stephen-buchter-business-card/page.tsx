...
export const metadata: Metadata = {
  title: { absolute: "Stephen Buchalter | President | Enterprise Cleaning Corp" },
  description: "Official digital business card for Stephen Buchalter, President at Enterprise Cleaning Corporation. Contact directly or download vCard / PDF.",
  alternates: {
    canonical: "https://www.enterprisecleaningcorp.com/stephen-buchter-business-card"
  },
  robots: {
    index: true,
    follow: true,
...
VERSION:3.0
FN:Stephen Buchalter
N:Buchalter;Stephen;;;
ORG:Enterprise Cleaning Corporation
TITLE:President
TEL;TYPE=CELL,VOICE:508-509-1423
TEL;TYPE=WORK,VOICE:508-890-1000
EMAIL;TYPE=WORK:sbuchalter@enterprisecleaningcorp.com
URL:https://www.enterprisecleaningcorp.com
ADR;TYPE=WORK:;;99 Hartwell St;West Boylston;MA;01583;USA
END:VCARD`;

export default function StephenBuchterBusinessCardPage() {
      ...
      <div className="container mx-auto max-w-4xl relative z-10 space-y-6 sm:space-y-10">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-white/80 font-normal">508-509-1423</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-[11px] text-slate-400 font-normal truncate max-w-full">sbuchalter@enterprisecleaningcorp.com</span>
            </div>
          </a>

          <a
            href={vCardDataUri}
            download="Stephen_Buchalter_Enterprise_Cleaning.vcf"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-white font-bold text-sm sm:text-base group-hover:text-[#0090c8] transition-colors">508-509-1423</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-white font-bold text-xs sm:text-base truncate group-hover:text-[#0090c8] transition-colors">sbuchalter@enterprisecleaningcorp.com</div>
              </div>
            </a>
            ...
            <div className="flex items-center gap-3.5 bg-slate-900/60 p-3.5 sm:p-4 rounded-2xl border border-slate-700/60 sm:col-span-2">
              ...
              <div className="min-w-0">
                ...
                <div className="text-white font-bold text-xs sm:text-sm">99 Hartwell St, West Boylston, MA 01583</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#0090c8] to-[#006088] rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center text-white shadow-2xl space-y-4 sm:space-y-6">
          ...
          <p className="text-white/90 text-xs sm:text-sm max-w-xl mx-auto font-medium leading-relaxed">
            Contact Stephen Buchalter directly or request an on-site walkthrough for your facility in Central MA, Rhode Island, or Southern NH.
          </p>
