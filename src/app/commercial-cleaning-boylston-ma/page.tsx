...
export const metadata: Metadata = {
  title: { absolute: "Commercial Cleaning Boylston, MA | Enterprise Cleaning Corp" },
  description: "Commercial cleaning and janitorial services in Boylston, MA. Serving Route 140 businesses and light-industrial tenants near Worcester. Get a free quote.",
  keywords: "commercial cleaning services, commercial cleaner near me, business cleaning service near me, janitorial company near me, commercial cleaning ma, commercial cleaning services massachusetts, floor cleaning massachusetts, office cleaning service near me, commercial cleaning boylston ma",
  alternates: {
    canonical: "https://www.enterprisecleaningcorp.com/commercial-cleaning-boylston-ma"
  },
  robots: {
    index: true,
    follow: true,
...
const structuredDataService = {
  ...
  "url": "https://www.enterprisecleaningcorp.com/commercial-cleaning-boylston-ma"
};
...
const structuredDataFAQ = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does Enterprise Cleaning Corporation serve Boylston, MA?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Boylston is part of our core service area, and our headquarters in neighboring West Boylston is just minutes away." }
    },
    {
      "@type": "Question",
      "name": "Do you serve small businesses in Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We work with businesses of all sizes in Boylston, including small offices and light-industrial tenants along Route 140." }
    },
    {
      "@type": "Question",
      "name": "What cleaning services are available for Boylston businesses?",
      "acceptedAnswer": { "@type": "Answer", "text": "Nightly janitorial, day porter services, floor care, window cleaning and pressure washing, and turnover cleaning are all available in Boylston." }
    },
    {
      "@type": "Question",
      "name": "How much does commercial cleaning cost in Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Pricing depends on the size and type of business. We provide a free on-site walkthrough and written quote for every Boylston property, regardless of size." }
    },
    {
      "@type": "Question",
      "name": "Is there a local cleaning company that serves small towns like Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Because we're headquartered in neighboring West Boylston, Boylston's small businesses get the same responsive, owner-accessible service as our larger accounts." }
    },
    {
      "@type": "Question",
      "name": "Do you clean light-industrial facilities near Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We serve light-industrial and warehouse tenants in and around Boylston along the Route 140 corridor." }
    },
    {
      "@type": "Question",
      "name": "How often should a small office in Boylston be professionally cleaned?",
      "acceptedAnswer": { "@type": "Answer", "text": "Most small offices are cleaned two to five nights a week depending on traffic and square footage, which we assess during a free walkthrough." }
    },
    {
      "@type": "Question",
      "name": "Does Enterprise Cleaning Corporation offer day porter services in Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Day porter coverage is available for Boylston businesses that need daytime cleaning support in addition to nightly service." }
    },
    {
      "@type": "Question",
      "name": "What industries does Enterprise Cleaning Corporation serve in Boylston?",
      "acceptedAnswer": { "@type": "Answer", "text": "Small professional offices, light-industrial tenants, and property management accounts along the Route 140 corridor in Boylston." }
    },
    {
      "@type": "Question",
      "name": "How do I get a cleaning quote for my Boylston business?",
      "acceptedAnswer": { "@type": "Answer", "text": "Call (508) 890-1000. Because we're based just next door in West Boylston, we can typically schedule a Boylston walkthrough quickly." }
    }
  ]
};

export default function BoylstonCityPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[520px]">
            ...
            <div className="py-12 lg:py-16 pr-0 lg:pr-8 space-y-7">
              <div className="inline-flex items-center gap-2 text-sm font-bold text-[#0090c8] bg-[#0090c8]/8 border border-[#0090c8]/20 px-4 py-1.5 rounded-full">
                ...
                Boylston, MA &bull; Headquarters Adjacent
              </div>
              ...
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-black leading-[1.1] tracking-tight text-slate-900">
                  ...
                  <span className="text-[#0090c8]">in Boylston, MA</span>
                </h1>
              </div>

              <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-xl">
                Boylston is part of our core home territory, just minutes from our West Boylston headquarters. Enterprise Cleaning Corporation provides tailored janitorial, floor care, and day porter services for Route 140 small businesses and light-industrial facilities.
              </p>
            ...
            <div className="relative block pb-8 lg:py-10">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200">
                <Image
                  src="/images/boylston_cleaning_hero.png"
                  alt="Commercial Cleaning in Boylston MA"
                  fill
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {[
              ...
              { val: "HQ Next Door", unit: "", label: "West Boylston Based" },
            ].map((s, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#0090c8] mb-2">Built for Boylston</p>
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight max-w-3xl">
                Commercial Cleaning Built for Boylston&apos;s Business Community
              </h2>
            </div>
            <div className="grid lg:grid-cols-5 gap-8 items-start">
              ...
              <div className="lg:col-span-3 space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem]">
                <p>
                  Boylston is a small, largely rural town of roughly 4,800 residents in Worcester County, settled along the Nashua River and known today for the Wachusett Reservoir and Tower Hill Botanic Garden as much as for its commercial base. The town has retained much of its rural character, but its position along Route 140 and its proximity to Worcester, Shrewsbury, and West Boylston mean Boylston is not purely residential — a steady mix of small businesses, professional offices, and light-industrial tenants operate along the town&apos;s main commercial corridors, often serving customers who commute in from the surrounding cities for work while calling Boylston home, or vice versa.
                </p>
                <p>
                  Because Boylston is small, most local businesses don&apos;t have the volume to justify a large in-house facilities team, and many are wary of national cleaning franchises that treat a town this size as an afterthought. What Boylston businesses need is a cleaning partner who takes a small account as seriously as a large one and who is already familiar with the town.
                </p>
                <p>
                  Enterprise Cleaning Corporation is headquartered in neighboring West Boylston, just a few minutes from Boylston&apos;s Route 140 corridor, and we bring the same 97% client retention standard and owner-accessible service model offering{" "}
                  ...
                  <Link href="/floor-care-services-central-ma" className="text-[#0090c8] font-semibold hover:underline">floor care cleaning</Link>
                  {" "}to Boylston&apos;s small businesses and light-industrial tenants that we apply to our largest accounts.
                </p>
                <p>
                  A town the size of Boylston rarely gets much attention from larger regional or national cleaning companies, who tend to prioritize accounts with more square footage. Because we&apos;re headquartered next door, Boylston isn&apos;t a detour for us — it&apos;s part of our home territory, and we quote and service it that way.
                </p>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="bg-slate-50 rounded-3xl p-6 border border-slate-200">
                  ...
                  <p className="text-slate-500 text-xs font-medium mb-4">Enterprise Cleaning Corporation serves commercial properties throughout Boylston, including:</p>
                  <div className="space-y-2">
                    {[
                      { area: "Route 140 Commercial Corridor", detail: "Small offices, service businesses, and light-industrial tenants" },
                      { area: "Boylston Town Center", detail: "Municipal and small professional office space" },
                      { area: "Route 70 & Tower Hill Area", detail: "Event and hospitality-adjacent commercial space" },
                      { area: "Shrewsbury / West Boylston Border", detail: "Commercial and office accounts near town lines" },
                    ].map((d, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-slate-500 font-medium leading-relaxed">
              Our headquarters in neighboring West Boylston puts us minutes from Boylston&apos;s Route 140 businesses, and because we&apos;re already local, Boylston accounts get the same direct, owner-accessible service as our largest clients rather than being treated as an afterthought.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: MapPin, title: "Based Minutes Away", text: "Headquartered in West Boylston, giving Boylston businesses ultra-fast response times and dedicated care." },
            ].map((item, idx) => (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Core Cleaning Services in Boylston, MA
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed">
              Enterprise Cleaning Corporation provides a full range of commercial cleaning services to Boylston businesses, scaled to fit everything from a single office suite to a multi-building portfolio:
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="max-w-2xl mx-auto text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Industries We Serve in Boylston
            </h2>
            <p className="text-slate-500 font-medium">
              Our Boylston accounts span a range of industries, each with its own cleaning standards and scheduling requirements:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                { num: "01", title: "Free On-Site Walkthrough", text: "A member of our team visits your Boylston property — no subcontractors, no sales reps." },
            ...
            <div className="space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem] border-t border-slate-100 pt-8">
              ...
              <p>
                ...
                {" "}a tenant who works late. Consistency in staffing is one of the most requested — and least delivered — things facility managers ask for from a cleaning vendor, and it&apos;s built into how we staff every Boylston account from day one.
              </p>
              <p>
              ...
              <p>
                Every Boylston crew is fully insured and bonded, trained on the equipment and cleaning chemicals used on your property, and briefed on any building-specific access, security, or safety requirements before their first shift. If your Boylston property has a facility handbook, badge-in procedure, or vendor compliance requirement, we build our onboarding around it rather than asking you to work around us.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/boylston_cleaning_banner.png"
            alt="Commercial cleaning in Boylston MA"
            fill
            className="object-cover object-center"
          />
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-white leading-tight">
                Serving Boylston and the Surrounding Area
              </h2>
              <div className="space-y-4 text-slate-200 font-medium leading-relaxed text-[0.97rem]">
                <p>
                  In addition to Boylston, Enterprise Cleaning Corporation regularly services commercial properties in the surrounding communities of West Boylston, Shrewsbury, Berlin, Northborough, and throughout the broader Central Massachusetts, Rhode Island, and Southern New Hampshire region.
                </p>
                <p>
                  For a small Boylston business owner, that means getting the same free walkthrough, written quote, and dedicated crew that our largest Worcester or Providence accounts receive — sized appropriately for a smaller property, but delivered with the same level of attention.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: MapPin, stat: "HQ Nearby", label: "West Boylston Base" },
              ].map((item, i) => (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3">
                Frequently Asked Questions — Boylston, MA
              </h2>
              <p className="text-slate-500 font-medium">
                Common questions about our commercial cleaning services in Boylston.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight">
                Get a Free Cleaning Quote for Your Boylston Property
              </h2>
              <p className="text-slate-500 font-medium mt-4 leading-relaxed">
                Enterprise Cleaning Corporation offers a free, no-obligation on-site walkthrough for every Boylston property. Call (508) 890-1000 or request a quote online to schedule yours and receive a written proposal built around your building, your schedule, and your budget.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                Get a Free Boylston Quote <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="tel:5088901000"
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              {["Fully Insured & Bonded", "97% Client Retention", "4× WBJ Best of Business", "Route 140 Corridor"].map(chip => (
