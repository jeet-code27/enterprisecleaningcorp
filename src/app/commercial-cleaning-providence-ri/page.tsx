...
const structuredDataService = {
  ...
  "url": "https://www.enterprisecleaningcorp.com/commercial-cleaning-providence-ri"
};
...
const structuredDataFAQ = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Do you clean office buildings in downtown Providence?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We clean Class A and Class B office buildings throughout Downcity and the surrounding downtown Providence business district." }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How much does commercial cleaning cost in Providence?",
      "acceptedAnswer": { "@type": "Answer", "text": "Cost depends on square footage, tenant type, and cleaning frequency. We provide a free on-site walkthrough and written quote for every Providence property." }
    },
    {
      "@type": "Question",
      "name": "Do you clean medical offices in Providence, RI?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We clean medical and healthcare administrative offices throughout Providence using cleaning protocols built for patient-facing facilities." }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How is Enterprise Cleaning Corporation different from national cleaning franchises in Providence?",
      "acceptedAnswer": { "@type": "Answer", "text": "Providence clients get direct access to company leadership rather than a franchise call center, backed by a 97% client retention rate across our full service area." }
    },
    {
      "@type": "Question",
      "name": "How often should a downtown Providence office be professionally cleaned?",
      "acceptedAnswer": { "@type": "Answer", "text": "Most downtown Providence offices are cleaned five nights a week; higher-traffic buildings near Brown, RISD, or the Innovation District may need daily service." }
    },
    {
      "@type": "Question",
      "name": "What industries does Enterprise Cleaning Corporation serve in Providence?",
      "acceptedAnswer": { "@type": "Answer", "text": "Corporate and financial offices, medical and healthcare facilities, educational-adjacent office space, and property management portfolios throughout downtown Providence." }
    },
    {
      "@type": "Question",
      "name": "How do I request a cleaning quote for my Providence property?",
      "acceptedAnswer": { "@type": "Answer", "text": "Call (508) 890-1000 to schedule a free walkthrough and receive a written proposal for your Providence, RI property." }
    }
  ]
};

export default function ProvidenceCityPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[520px]">
            ...
            <div className="py-12 lg:py-16 pr-0 lg:pr-8 space-y-7">
              <div className="inline-flex items-center gap-2 text-sm font-bold text-[#0090c8] bg-[#0090c8]/8 border border-[#0090c8]/20 px-4 py-1.5 rounded-full">
                ...
                Providence, RI &bull; Rhode Island Hub
              </div>
              ...
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-black leading-[1.1] tracking-tight text-slate-900">
                  ...
                  <span className="text-[#0090c8]">in Providence, Rhode Island</span>
                </h1>
              </div>
            ...
            <div className="relative block pb-8 lg:py-10">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200">
                <Image
                  src="/images/providence_cleaning_hero.png"
                  alt="Commercial Cleaning in Providence RI"
                  fill
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {[
              ...
              { val: "RI & MA", unit: "", label: "Service Coverage" },
            ].map((s, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#0090c8] mb-2">Built for Providence</p>
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight max-w-3xl">
                Commercial Cleaning Built for Providence&apos;s Business Community
              </h2>
            </div>
            <div className="grid lg:grid-cols-5 gap-8 items-start">
              ...
              <div className="lg:col-span-3 space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem]">
                <p>
                  Providence is Rhode Island&apos;s capital and its largest city, with roughly 190,000 to 196,000 residents and a downtown core — locally known as Downcity — that has been steadily redeveloping around Brown University, the Rhode Island School of Design, and the Providence Innovation and Design District, the former I-195 land now branded the 195 District. That district alone has attracted more than 1,100 new housing units, research and office space, and a growing base of biotech, design, and technology tenants, adding to a downtown that already carries a dense mix of{" "}
                ...
                <p>
                  Rhode Island&apos;s commercial cleaning market is more crowded with national franchises than our Massachusetts home base, which is exactly why Providence clients tend to notice the difference in how we operate: a direct phone line to ownership, a consistent crew rather than rotating subcontractors, and a quote that reflects an actual walkthrough of the building rather than a square-footage formula. That&apos;s the same standard that built our 97% retention rate, applied to a new market.
                </p>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="bg-slate-50 rounded-3xl p-6 border border-slate-200">
                  ...
                  <p className="text-slate-500 text-xs font-medium mb-4">Enterprise Cleaning Corporation serves commercial properties throughout Providence, including:</p>
                  <div className="space-y-2">
                    {[
                      { area: "Downcity / Downtown Providence", detail: "Financial, legal, and professional office towers" },
                      { area: "Providence Innovation & Design District", detail: "195 District research, office & mixed-use development" },
                      { area: "Federal Hill & The West Side", detail: "Restaurant, retail, and small-office commercial strips" },
                      { area: "College Hill Area (Brown & RISD)", detail: "Education-adjacent office & administrative space" },
                    ].map((d, i) => (
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#0090c8] mb-2">The Regional Advantage</p>
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Why Local Businesses Choose Enterprise Cleaning Corporation
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed">
              Providence is a strategic expansion market for Enterprise Cleaning Corporation — one where we compete directly against national franchises by offering the same owner-accessible, consistency-first service model that has kept our retention rate at 97%.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: MapPin, title: "Serving Providence, RI", text: "Direct coverage for Downcity, the Innovation District, College Hill, and greater Providence." },
            ].map((item, idx) => (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Core Cleaning Services in Providence, RI
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed">
              Enterprise Cleaning Corporation provides a full range of commercial cleaning services to Providence businesses, scaled to fit everything from a single office suite to a multi-building portfolio:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="max-w-2xl mx-auto text-center mb-14">
            ...
            <p className="text-slate-500 font-medium">
              Our Providence accounts span a range of industries, each with its own cleaning standards and scheduling requirements:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                { num: "01", title: "Free On-Site Walkthrough", text: "A member of our team visits your Providence property — no subcontractors, no sales reps." },
            ...
            <div className="space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem] border-t border-slate-100 pt-8">
              ...
              <p>
                ...
                {" "}a tenant who works late. Consistency in staffing is one of the most requested — and least delivered — things facility managers ask for from a cleaning vendor, and it&apos;s built into how we staff every Providence account from day one.
              </p>
              <p>
              ...
              <p>
                Every Providence crew is fully insured and bonded, trained on the equipment and cleaning chemicals used on your property, and briefed on any building-specific access, security, or safety requirements before their first shift. If your Providence property has a facility handbook, badge-in procedure, or vendor compliance requirement, we build our onboarding around it rather than asking you to work around us.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/providence_cleaning_banner.png"
            alt="Commercial cleaning in Providence RI"
            fill
            className="object-cover object-center"
          />
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-white leading-tight">
                Serving Providence and the Surrounding Area
              </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: MapPin, stat: "RI & MA", label: "Service Area" },
              ].map((item, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-500 font-medium">
                Common questions about our commercial cleaning services in Providence.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight">
                Get a Free Cleaning Quote for Your Providence Property
              </h2>
              <p className="text-slate-500 font-medium mt-4 leading-relaxed">
                Enterprise Cleaning Corporation offers a free, no-obligation on-site walkthrough for every Providence property. Call (508) 890-1000 or request a quote online to schedule yours and receive a written proposal built around your building, your schedule, and your budget.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                Get a Free Providence Quote <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="tel:5088901000"
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              {["Fully Insured & Bonded", "97% Client Retention", "4× WBJ Best of Business", "Providence & Downcity"].map(chip => (
