...
export const metadata: Metadata = {
  title: { absolute: "Commercial Cleaning Nashua, NH | Enterprise Cleaning Corp" },
  description: "Commercial cleaning and janitorial services in Nashua, NH. Serving tech, defense, and corporate offices along Route 3. Get a free quote today.",
  keywords: "commercial cleaning services, commercial cleaning company, office cleaning services, commercial janitorial services, corporate cleaning services near me, industrial cleaning services near me, commercial cleaning near me, office cleaning company near me, commercial cleaning nashua nh",
  alternates: {
    canonical: "https://www.enterprisecleaningcorp.com/commercial-cleaning-nashua-nh"
  },
  robots: {
    index: true,
    follow: true,
...
const structuredDataService = {
  ...
  "url": "https://www.enterprisecleaningcorp.com/commercial-cleaning-nashua-nh"
};
...
const structuredDataFAQ = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does Enterprise Cleaning Corporation serve Nashua, NH?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Nashua is a primary focus of our Southern New Hampshire service area, covering technology, defense, and corporate office tenants." }
    },
    {
      "@type": "Question",
      "name": "Do you clean office parks like Gateway Hills in Nashua?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We serve technology and corporate office tenants throughout Nashua's business parks, including the Gateway Hills area." }
    },
    {
      "@type": "Question",
      "name": "Can Enterprise Cleaning Corporation work with defense contractors or technology firms that require background-checked staff?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. We coordinate staffing and access requirements with facility-specific security needs, which is common among Nashua's defense and technology tenants." }
    },
    {
      "@type": "Question",
      "name": "What cleaning services are available for Nashua office buildings?",
    ...
    {
      "@type": "Question",
      "name": "How much does commercial cleaning cost in Nashua, NH?",
      "acceptedAnswer": { "@type": "Answer", "text": "Pricing depends on square footage, building type, and frequency. We provide a free on-site walkthrough and written quote for every Nashua property." }
    },
    {
      "@type": "Question",
      "name": "Does Enterprise Cleaning Corporation serve businesses along Route 3 in Nashua?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. The Route 3/Everett Turnpike corridor is a core part of our Nashua service area." }
    },
    {
      "@type": "Question",
      "name": "How often should a Nashua corporate office be professionally cleaned?",
      "acceptedAnswer": { "@type": "Answer", "text": "Most Nashua offices are cleaned five nights a week; technology and defense facilities may need additional coverage depending on access requirements." }
    },
    {
      "@type": "Question",
      "name": "Does Enterprise Cleaning Corporation offer day porter services in Nashua?",
      "acceptedAnswer": { "@type": "Answer", "text": "Yes. Day porter coverage is available for Nashua businesses that need daytime restocking and spot cleaning in addition to nightly service." }
    },
    {
      "@type": "Question",
      "name": "What industries does Enterprise Cleaning Corporation serve in Nashua?",
      "acceptedAnswer": { "@type": "Answer", "text": "Technology and defense contractors, corporate offices, manufacturing, and property management portfolios throughout Nashua." }
    },
    {
      "@type": "Question",
      "name": "How do I get a cleaning quote for my Nashua property?",
      "acceptedAnswer": { "@type": "Answer", "text": "Call (508) 890-1000 to schedule a free walkthrough and receive a written proposal for your Nashua, NH property." }
    }
  ]
};

export default function NashuaCityPage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center min-h-[520px]">
            ...
            <div className="py-12 lg:py-16 pr-0 lg:pr-8 space-y-7">
              <div className="inline-flex items-center gap-2 text-sm font-bold text-[#0090c8] bg-[#0090c8]/8 border border-[#0090c8]/20 px-4 py-1.5 rounded-full">
                ...
                Nashua, NH &bull; Southern NH Tech Corridor
              </div>
              ...
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-black leading-[1.1] tracking-tight text-slate-900">
                  ...
                  <span className="text-[#0090c8]">in Nashua, New Hampshire</span>
                </h1>
              </div>

              <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-xl">
                Nashua is New Hampshire&apos;s second-largest city and a major technology &amp; defense hub. Enterprise Cleaning Corporation provides tailored janitorial, floor care, and day porter services for Gateway Hills, Route 3 tech parks, and corporate offices.
              </p>

              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-2 bg-[#0090c8] text-[#ffffff] font-extrabold px-7 py-3.5 rounded-xl hover:bg-[#0078a8] transition-colors shadow-md shadow-[#0090c8]/25 text-base w-full sm:w-auto"
                >
              ...
              <div className="flex flex-wrap gap-3">
                {["97% Client Retention", "4× WBJ Award Winner", "BBB Accredited Since 2007", "23+ Years Regional"].map(chip => (
            ...
            <div className="relative block pb-8 lg:py-10">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-200">
                <Image
                  src="/images/nashua_cleaning_hero.png"
                  alt="Commercial Cleaning in Nashua NH"
                  fill
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {[
              ...
              { val: "Route 3", unit: "", label: "Tech Corridor" },
            ].map((s, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#0090c8] mb-2">Built for Nashua</p>
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight max-w-3xl">
                Commercial Cleaning Built for Nashua&apos;s Business Community
              </h2>
            </div>
            <div className="grid lg:grid-cols-5 gap-8 items-start">
              ...
              <div className="lg:col-span-3 space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem]">
                <p>
                  Nashua is New Hampshire&apos;s second-largest city, with a population above 90,000, and it sits at the southern edge of the state along the Route 3/Everett Turnpike corridor — close enough to the Massachusetts border to draw businesses that want New Hampshire&apos;s tax advantages without giving up easy access to the Boston metro area. The city is organized into ten distinct business districts, and its technology and office parks, including the Gateway Hills complex housing Nashua Technology Park and Nashua Office Park, are home to tenants like BAE Systems, Dell, Amphenol, and Benchmark Electronics — a strong concentration of defense contractors, technology firms, and corporate offices in one part of the city.
                </p>
                <p>
                  That tenant mix means Nashua facility managers are frequently responsible for buildings with security and compliance considerations that go beyond a standard office cleaning contract — defense contractors and technology firms often require background-checked cleaning staff and coordination around restricted-access areas, in addition to the appearance standards any corporate tenant expects.
                </p>
                <p>
                ...
                <p>
                  Crossing into New Hampshire doesn&apos;t change how we operate: the same crews, scheduling standards, and direct line to ownership that Massachusetts clients rely on extend across the border to Nashua. For technology and defense tenants at Gateway Hills, that also means we&apos;re able to coordinate around access restrictions and staffing requirements without treating them as a special exception.
                </p>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="bg-slate-50 rounded-3xl p-6 border border-slate-200">
                  ...
                  <p className="text-slate-500 text-xs font-medium mb-4">Enterprise Cleaning Corporation serves commercial properties throughout Nashua, including:</p>
                  <div className="space-y-2">
                    {[
                      { area: "Gateway Hills / Tech & Office Park", detail: "Technology, defense, and corporate tenants (BAE, Dell, etc.)" },
                      { area: "Downtown Nashua", detail: "Municipal offices, restaurants, and small professional offices" },
                      { area: "Route 3 / Everett Turnpike Corridor", detail: "Corporate offices and light-industrial tenants" },
                      { area: "Amherst Street Commercial Corridor", detail: "Retail shopping centers and service businesses" },
                    ].map((d, i) => (
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-slate-500 font-medium leading-relaxed">
              Nashua&apos;s concentration of defense contractors and technology firms in business parks like Gateway Hills calls for a cleaning partner comfortable with background-checked staffing and access coordination, which is standard practice for our corporate and industrial accounts.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: MapPin, title: "Southern NH Tech Experts", text: "Background-checked staffing and access coordination for Gateway Hills, defense, and tech accounts." },
            ].map((item, idx) => (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Core Cleaning Services in Nashua, NH
            </h2>
            <p className="text-slate-500 font-medium leading-relaxed">
              Enterprise Cleaning Corporation provides a full range of commercial cleaning services to Nashua businesses, scaled to fit everything from a single office suite to a multi-building portfolio:
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="max-w-2xl mx-auto text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
              Industries We Serve in Nashua
            </h2>
            <p className="text-slate-500 font-medium">
              Our Nashua accounts span a range of industries, each with its own cleaning standards and scheduling requirements:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                { num: "01", title: "Free On-Site Walkthrough", text: "A member of our team visits your Nashua property — no subcontractors, no sales reps." },
            ...
            <div className="space-y-4 text-slate-600 font-medium leading-relaxed text-[0.97rem] border-t border-slate-100 pt-8">
              ...
              <p>
                ...
                {" "}a tenant who works late. Consistency in staffing is one of the most requested — and least delivered — things facility managers ask for from a cleaning vendor, and it&apos;s built into how we staff every Nashua account from day one.
              </p>
              <p>
              ...
              <p>
                Every Nashua crew is fully insured and bonded, trained on the equipment and cleaning chemicals used on your property, and briefed on any building-specific access, security, or safety requirements before their first shift. If your Nashua property has a facility handbook, badge-in procedure, or vendor compliance requirement, we build our onboarding around it rather than asking you to work around us.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/nashua_cleaning_banner.png"
            alt="Commercial cleaning in Nashua NH"
            fill
            className="object-cover object-center"
          />
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5">
              ...
              <div className="space-y-4 text-slate-200 font-medium leading-relaxed text-[0.97rem]">
                <p>
                  In addition to Nashua, Enterprise Cleaning Corporation regularly services commercial properties in the surrounding communities of Merrimack, Hudson, Amherst NH, Tyngsborough MA, and throughout the broader Central Massachusetts, Rhode Island, and Southern New Hampshire region.
                </p>
                <p>
                  For a Nashua facility manager at a technology or defense company, that means a cleaning vendor who can meet background-check and access-coordination requirements without treating them as a special accommodation — because that kind of coordination is a normal part of how we staff corporate and industrial accounts across our entire service area.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: MapPin, stat: "Southern NH", label: "Tech Corridor" },
              ].map((item, i) => (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3">
                Frequently Asked Questions — Nashua, NH
              </h2>
              <p className="text-slate-500 font-medium">
                Common questions about our commercial cleaning services in Nashua.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-tight">
                Get a Free Cleaning Quote for Your Nashua Property
              </h2>
              <p className="text-slate-500 font-medium mt-4 leading-relaxed">
                Enterprise Cleaning Corporation offers a free, no-obligation on-site walkthrough for every Nashua property. Call (508) 890-1000 or request a quote online to schedule yours and receive a written proposal built around your building, your schedule, and your budget.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                Get a Free Nashua Quote <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                href="tel:5088901000"
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-2">
              {["Fully Insured & Bonded", "97% Client Retention", "4× WBJ Best of Business", "Route 3 & Gateway Hills"].map(chip => (
