...
export const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col overflow-hidden" style={{ background: "#020c18" }}>
      ...
      {/* ── HERO CONTENT ─────────────────────────────────────── */}
      <div className="relative z-10 flex flex-col justify-center flex-1 px-4 sm:px-10 lg:px-20 pt-24 sm:pt-28 pb-16 sm:pb-20 max-w-[1400px] mx-auto w-full">
        ...
        <motion.div {...fadeUp(0.25)} className="mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white leading-[1.25] sm:leading-[1.2] tracking-[-0.01em] max-w-3xl break-words">
        ...
        {/* CTA Buttons */}
        <motion.div {...fadeUp(0.55)} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-8 sm:mb-14 w-full sm:w-auto">
          <Link
            href="/contact"
            className="group relative inline-flex items-center justify-center gap-2 bg-[#E31837] text-white px-5 sm:px-7 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 hover:bg-[#c91530] hover:shadow-[0_8px_40px_rgba(227,24,55,0.45)] hover:-translate-y-0.5 overflow-hidden h-12 w-full sm:w-auto text-center"
          >
          ...
          <a
            href="tel:5088901000"
            className="group inline-flex items-center justify-center gap-2.5 border border-white/25 bg-white/8 backdrop-blur-md text-white px-6 sm:px-7 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 hover:border-[#00B8FF]/60 hover:bg-white/15 hover:-translate-y-0.5 h-12 w-full sm:w-auto text-center"
          >
            <Phone className="w-4 h-4 text-[#00B8FF] shrink-0" />
            (508) 890-1000
          </a>
        </motion.div>
